...
void Game::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->enterHub(); break;
        case 2: _t->missionCompleted(); break;
        case 3: _t->onMissionCompleted(); break;
        default: ;
        }
        ...
        {
            using _t = void (Game::*)();
            if (_t _q_method = &Game::enterHub; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Game::*)();
            if (_t _q_method = &Game::missionCompleted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Game::gameStateChanged(const QString & _t1)
{
